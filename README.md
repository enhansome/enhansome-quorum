...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 497,186 | 🐛 104 | 📅 2026-06-30
...
* [Hyperledger Besu](https://github.com/hyperledger/besu) ⭐ 1,827 | 🐛 192 | 🌐 Java | 📅 2026-08-18 - Enterprise Ethereum client written in Java under Apache 2.0 license, compatible with both public and permissioned networks

### Private Transaction Manager

* [Tessera](https://github.com/ConsenSys/tessera) ⚠️ Archived - Stateless Java system enabling encryption, decryption, and distribution of private transactions for Quorum

### Private Key Manager

* [EthSigner](https://github.com/ConsenSys/ethsigner) ⚠️ Archived - Transaction signing application to be used with a web3 provider
* [Quorum Signer Hashicorp](https://github.com/ConsenSys/quorum-signer-plugin-for-hashicorp-vault) ⚠️ Archived -  Custom plugin backend for Hashicorp Vault adding a new `quorum-signer` secret-engine to Hashicorp Vault
...
* [web3j-quorum](https://github.com/web3j/web3j-quorum) ⭐ 120 | 🐛 1 | 🌐 Java | 📅 2023-05-16 - An extension to web3j providing support for Quorum APIs
* [Web3Quorum](https://github.com/chainstack/web3quorum) ⚠️ Archived - A web3py extension that supports Quorum APIs: Raft and Istanbul.
* [Quorum-toolbox](https://github.com/chainstack/quorum-toolbox) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2020-05-28 - Tools and scripts for Quorum configuration.
...
* [GoQuorum Acceptance Test](https://github.com/ConsenSys/quorum-acceptance-tests) ⚠️ Archived - Acceptance Tests for GoQuorum
...
* [Quorum Kubernetes](https://github.com/ConsenSys/quorum-kubernetes) ⭐ 134 | 🐛 8 | 🌐 Mustache | 📅 2025-11-02 - Example reference implementations of private networks using k8s, intended for developers and ops to get familiar with private ethereum network in k8s
...
* [GoQuorum whitepaper](https://github.com/ConsenSys/quorum/blob/master/docs/Quorum%20Whitepaper%20v0.2.pdf) ⚠️ Archived
* [BFT specifications](https://github.com/ConsenSys/quorum-ibft) ⚠️ Archived - Paper describing the BFT Consensus Algorithm, a simple and elegant algorithm for Byzantine fault-tolerant consensus and is used to implement state machine replication in the Quorum blockchain
...
* [Contribute to Besu](https://github.com/hyperledger/besu/blob/master/CONTRIBUTING.md) ⭐ 1,827 | 🐛 192 | 🌐 Java | 📅 2026-08-18
...
* [GoQuorum Wiki](https://github.com/ConsenSys/quorum/wiki) ⚠️ Archived
...
* [ZSL proof of concept](https://github.com/ConsenSys/quorum/wiki/ZSL) ⚠️ Archived - ZSL for GoQuorum enables the issuance of
...
* [web3j token sample](https://github.com/blk-io/quorum-sample) ⭐ 13 | 🐛 0 | 🌐 Java | 📅 2021-02-10 - Demonstrates the creation and management of a private
  token on a GoQuorum network.
  Written in Java using web3j which is maintained by Web3 Labs.
* [Pons bridge](https://github.com/M-Bowe/pons) ⭐ 4 | 🐛 0 | 🌐 Java | 📅 2019-04-24 | [Pons-Frontend](https://github.com/M-Bowe/pons-frontend) ⭐ 2 | 🐛 0 | 🌐 HTML | 📅 2019-04-24 - A sample
  Cross-Chain Trading Bridge written to run over 2 GoQuorum Chains to safely exchange ERC-20 and ERC-721 assets.
* [QBFT Testnet](https://github.com/entethalliance/qbft-testnet) ⚠️ Archived - an Enterprise Ethereum Alliance initiative to create
